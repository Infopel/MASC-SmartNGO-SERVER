...
export const actionTypes = [
  {id: '1', descricao: 'palestra'},
  {id: '2', descricao: 'oficina temática'},
  {id: '3', descricao: 'conversas que inspiram'},
  {id: '4', descricao: 'formação'},
  {id: '5', descricao: 'conversas que inspiram'},
